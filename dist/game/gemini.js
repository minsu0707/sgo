...
export async function askGemini(apiKey, question, secretName, secretHint) {
    const prompt = [
    ...
    try {
        ...
        if (text.includes("아니오") || text.includes("아니요"))
            return { ok: true, answer: "아니오" };
        if (text.includes("예"))
            return { ok: true, answer: "예" };
